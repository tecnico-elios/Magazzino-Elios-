  ...
  return (
    <div className="space-y-4 max-w-3xl" data-testid="inventory-source-tab">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        >
          ...
          <ul className="mt-3 text-xs text-slate-500 space-y-1 list-disc pl-4">
            <li>Prodotti locali attualmente: <b className="text-slate-800">{loading ? "…" : localCount}</b></li>
          ...
          {active !== "gestionale" && (
            <Button
              ...
              className="mt-4 h-10 w-full bg-sky-600 hover:bg-sky-700 text-white disabled:bg-sky-100 disabled:text-sky-400"
      ...
      <div className="rounded-md border border-amber-200 bg-amber-50 text-amber-900 text-xs p-3">
        ...
        entrambe le sorgenti contemporaneamente. Notion non viene mai modificato dallo switch.
      </div>
