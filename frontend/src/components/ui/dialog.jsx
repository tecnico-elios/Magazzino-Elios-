...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // F14 (ott. popup, 20/02) — Fix globale per TUTTI i popup del gestionale:
        //  • larghezza responsive con margine su mobile (w-[calc(100vw-1.5rem)])
        //  • max-h dinamica (usa dvh per iOS/Android toolbar) e scroll verticale
        //  • overscroll-contain evita che lo scroll fuoriesca sul body sottostante
